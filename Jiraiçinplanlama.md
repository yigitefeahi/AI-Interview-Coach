...
Bu doküman, `PRD.md` PRD’sindeki MVP kapsamını **Epic → Story → Task** hiyerarşisiyle parçalar. Jira’da Epic ve Story tipleri, alt işler ise Task/Sub-task olarak açılabilir.

**Repo / ürün:** AI-Interview-Coach (web odaklı teslimat; PRD’deki web/responsive yaklaşımı tarayıcı ekranlarına uygulanır.)
